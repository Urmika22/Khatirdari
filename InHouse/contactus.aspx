<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="contactus.aspx.cs" Inherits="InHouse.contactus" %>
    ...
    <table class="auto-style7">
        ...
        <tr>
            <td class="auto-style9"><span class="auto-style10"><strong>CALL US</strong></span><br />
                ...
                1(234)567-891<br />
                1(234)987-654<br />
                <asp:ImageMap ID="ImageMap1" runat="server" Height="45px" ImageUrl="~/picture/face.PNG"  Width="66px">
