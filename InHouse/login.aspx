<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="InHouse.login" %>
            ...
            <table class="auto-style2">
                <tr>
                    ...
                    <td class="auto-style4">
                        ...
                        <br />
                        <br />
                        <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/FirstHome.aspx">Back</asp:HyperLink>
                        <br />
                        <asp:Label ID="Label1" runat="server" Text="Want to get your restaurant listed on Khatirdari?" Width="550px" ForeColor="Black"></asp:Label>
                        <br />
                        <asp:HyperLink ID="HyperLink1" runat="server" Width="250px" NavigateUrl="~/registration.aspx">Partner with us</asp:HyperLink>
                        <br />
                        <br />
                        <br />
                        <br />
